(() => {
    ...
    function initSliders() {
        if (document.querySelector(".prices__slider")) new swiper_core_Swiper(".prices__slider", {
            ...
            on: {
                init: function(slider) {
                    if (slider.slides.length === 1) slider.pagination.bullets.forEach((bullet => {
        ...
        if (document.querySelector(".wishers__slider")) new swiper_core_Swiper(".wishers__slider", {
            modules: [ Navigation, Pagination ],
            observer: true,
            observeParents: true,
            slidesPerView: "auto",
